...
export const PROFILE_DATA = {
  ...
  cvUrl: "/kibum_moon_cv.pdf?v=6f1863aeee84",
...
export const CONFERENCE_PRESENTATIONS_DATA: ConferenceCategory[] = [
    {
        ...
        items: [
            { authors: ["Moon, K.", "Kushlev, K.", "Bank, A.", "Lira, B.", "Viskontas, I.", "Kaufman, J. C.", "Johnson, D. R.", "Duckworth, A. L.", "Green, A. E."], date: "2026, June 1-3", title: "The Creative Link Between Words and Ideas is Weakening in the AI Era.", conference: "Annual Conference of the Society for the Neuroscience of Creativity (SfNC)", location: "Philadelphia, PA." },
